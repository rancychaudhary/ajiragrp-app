            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="my-4">
                            <label for="image" class="form-label">image</label>
                            <input class="form-control" type="file" id="image" name="image" placeholder="Image" rows="10"></input>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="image_1" name="image_1" value="image_1">
                        </div>
                        <div class="mb-3">
                            <label for="image_2" class="form-label">image_2</label>
                            <input type="file" class="form-control" id="image_2" name="image_2" value="image_2">
                        </div>
                        {{-- <div class="mb-3">
                            <a href="{{ route('blogs.create') }}"
                                class="btn btn-sm btn-primary d-flex justify-content-between align-items-center gap-2">
